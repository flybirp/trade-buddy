...
放到你的 agent skills 目录即可（WorkBuddy / CodeBuddy 通用）：

```bash
# WorkBuddy
cp -r trade-buddy ~/.workbuddy/skills/

# 或通过 skills CLI
npx skills add flybirp/trade-buddy
```
...
```
帮我看下电广传媒，明天想买，赚 5 个点就走
/comtrade-buddy 挑个商业航天的标的，1 年内翻倍
金山软件港股值得买吗，期望 10%，需要多久
```

**只有两个信息会向你追问**：持有期限、目标收益率。其余（标的身份、当前价、财务、公告、同业、板块）全部自己取数补全。
